#ifndef LIGHTWATCH_KERNELS_H
#define LIGHTWATCH_KERNELS_H
...
#   include <cblas.h>
#   define LIGHTWATCH_HAS_CBLAS 1
# endif
#endif

inline void lstm_alloc(LSTM& M){
    M.Wxi = (float*)lightwatch_aligned_malloc((size_t)VOCAB_SIZE*HIDDEN*sizeof(float));
    M.Whi = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*HIDDEN*sizeof(float));
    M.bi  = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*sizeof(float));
    M.Wxf = (float*)lightwatch_aligned_malloc((size_t)VOCAB_SIZE*HIDDEN*sizeof(float));
    M.Whf = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*HIDDEN*sizeof(float));
    M.bf  = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*sizeof(float));
    M.Wxo = (float*)lightwatch_aligned_malloc((size_t)VOCAB_SIZE*HIDDEN*sizeof(float));
    M.Who = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*HIDDEN*sizeof(float));
    M.bo  = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*sizeof(float));
    M.Wxg = (float*)lightwatch_aligned_malloc((size_t)VOCAB_SIZE*HIDDEN*sizeof(float));
    M.Whg = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*HIDDEN*sizeof(float));
    M.bg  = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*sizeof(float));
    M.Why = (float*)lightwatch_aligned_malloc((size_t)HIDDEN*VOCAB_SIZE*sizeof(float));
    M.by  = (float*)lightwatch_aligned_malloc((size_t)VOCAB_SIZE*sizeof(float));
}
inline void lstm_free(LSTM& M){
    lightwatch_aligned_free(M.Wxi); lightwatch_aligned_free(M.Whi); lightwatch_aligned_free(M.bi);
    lightwatch_aligned_free(M.Wxf); lightwatch_aligned_free(M.Whf); lightwatch_aligned_free(M.bf);
    lightwatch_aligned_free(M.Wxo); lightwatch_aligned_free(M.Who); lightwatch_aligned_free(M.bo);
    lightwatch_aligned_free(M.Wxg); lightwatch_aligned_free(M.Whg); lightwatch_aligned_free(M.bg);
    lightwatch_aligned_free(M.Why); lightwatch_aligned_free(M.by);
